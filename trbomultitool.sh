...
ticker=TRBO
coindir=trbo
binaries='https://github.com/TRBO-Coin/Wallet/releases/download/V1.1/LinuxUbuntu16Daemon_v1.1.tar.gz'
...
#Tools
    ...
    #Get check.sh
    wget https://raw.githubusercontent.com/TRBO-Coin/Masternode/master/check.sh -O check.sh
    chmod +x check.sh
    #Finish
    ...
    $alias addnode 94.177.242.241 add
    $alias addnode 185.35.64.141 add
    $alias addnode 94.177.251.97 add
    echo "done..."
    exit
    ;;
    99) echo ${version}
