...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='trbo.conf'
CONFIGFOLDER='/root/.trbo'
COIN_DAEMON='trbod'
COIN_CLI='trbo-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/TRBO-Coin/Wallet/releases/download/V1.1/LinuxUbuntu16Daemon_v1.1.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_BOOTSTRAP='https://github.com/TRBO-Coin/Wallet/releases/download/V1.1/bootstrap.zip'
...
addnode=94.177.251.97
addnode=185.35.64.141
addnode=94.177.242.241
addnode=78.141.204.119
addnode=213.136.86.60
...
function important_information() {
 ...
 echo -e "${GREEN}trbo-cli masternode status${NC}"
 echo -e "${GREEN}trbo-cli getinfo${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
